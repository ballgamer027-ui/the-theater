...
const PROJECTS = [
  {
    ...
    pricing: {
      ...
      vip: {
        ...
        features: [
          'เข้าถึง Discord VIP Zone — ห้อง #vip-support + #command-center',
        ...
        note: '* ลิงก์เชิญ Discord ส่งอัตโนมัติทางอีเมลหลังชำระเงิน'
      }
    },
    phases: [
      {
...
3. 🏢 Station-as-a-Service (SaaS):
   ...
   - ฟันกำไรจากค่า Setup ก้อนแรก และเก็บค่าดูแล (MA) รายเดือน`
          },
          {
            ...
            codeLang: 'javascript',
            codeSnippet: `// 🔐 [ACCESS GRANTED — VIP RUN-WITH-YOU]
// ================================================================

// ✅ STEP 1: ตรวจสอบอีเมลที่ใช้ชำระเงิน
// ระบบส่งลิงก์เชิญ Discord ไปที่อีเมลของคุณโดยอัตโนมัติหลังการชำระเงิน
// → เช็ค Inbox หรือโฟลเดอร์ Spam ได้เลย

// ✅ STEP 2: โครงสร้าง Discord ที่คุณเข้าถึงได้

// 👥 CUSTOMER ZONE  (สำหรับผู้ซื้อ Manual 1,590 และ Workflow 5,900)
//    📌 #คู่มือ         → คู่มือติดตั้งและไฟล์ Workflow ครบชุด
//    💬 #พูดคุยทั่วไป   → ถามตอบ แชร์ประสบการณ์กับสมาชิกคนอื่น
//    💡 #เสนอไอเดีย    → ส่ง Feature Request และไอเดียพัฒนาระบบ

// 👑 ARCHITECT ZONE  (สำหรับผู้ซื้อ VIP 15,900 เท่านั้น)
//    🛠️ #vip-support    → ซัพพอร์ตแบบตัวต่อตัว ไล่บั๊กจนระบบนิ่ง
//    🧠 #command-center → เทคนิคขั้นสูง Config ลึก และ Update ก่อนใคร

// ================================================================
// ⚠️  ถ้าไม่ได้รับอีเมลภายใน 15 นาที ให้แจ้งในช่อง #ประกาศข่าวสาร`
          }
        ]
      }
    ]
